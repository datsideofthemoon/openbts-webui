...
SECTIONS = [
			("Control location update procedure" , 
				['Control.LUR.AttachDetach',
				'Control.LUR.CachedAuthentication',
				'Control.LUR.DefaultAuthenticationAccept',
				...
				'Control.LUR.SR-HTTPAuthentication',
				'Control.LUR.SendTMSIs',
				'Control.LUR.UnprovisionedRejectCause']),
			("GSM Identity" ,
				['GSM.Identity.BSIC.BCC',
				'GSM.Identity.BSIC.NCC',
				'GSM.Identity.CI',
				'GSM.Identity.LAC',
				'GSM.Identity.MCC',
				'GSM.Identity.MNC',
				'GSM.Identity.ShortName',
				'GSM.Identity.ShowCountry']),
			("GSM Radio", 
				['GSM.Radio.Band',
				'GSM.Radio.C0',
				'GSM.Radio.PowerManager.MaxAttenDB',
				'GSM.Radio.PowerManager.MinAttenDB',
